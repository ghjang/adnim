...
class Display3DPlot(Scene):
    def construct(self):
        ...
        simplified_tex.next_to(expanded_tex, DOWN, buff=0.3).align_to(expanded_tex, LEFT)
        collected_tex.next_to(simplified_tex, DOWN, buff=0.3).align_to(simplified_tex, LEFT)
        ...
        derivative_text.next_to(collected_tex, DOWN, buff=0.4).align_to(collected_tex, LEFT)
